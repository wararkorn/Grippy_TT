...
#     global yaxis_error,xaxis_error,angle_1,angle_2,angle_1_min,angle_2_min,angle_1_max,angle_2_max
#     angle_1 = 37
#     angle_2 = -12
#     angle_1_max = 0
#     angle_2_max = 0
...
if __name__ == "__main__":
    ...
    robot_process.start()
    # servo = threading.Thread(target=servo_controller)
    # servo.start()
